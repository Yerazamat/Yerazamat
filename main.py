...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        btn_clr1 = (0.25,0.4,0.35,1)
        self.btn.background_color = btn_clr1
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn.on_press = self.next
        btn_clr2 = (0.25,0.4,0.35,1)
        self.btn.background_color = btn_clr2
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn.on_press = self.next
        btn_clr3 = (0.25,0.4,0.35,1)
        self.btn.background_color = btn_clr3
